...
class Processor:
    ...
    ######################################################################
    def get_images_sentinel1(self, coordinates):
    ...
    def main(self):
        ...
        for polygon in self.polygon:
            image_date1, image_date2 = self.get_images_sentinel1(coordinates=polygon)
            print('\n************ downloading image one ************')
            self.turn_image_to_raster(image=image_date1, title='sent_date1_', coordinate=polygon,
                                      folder=self.date1_path + '/')
            print('\n************ downloading image two ************')
            self.turn_image_to_raster(image=image_date2, title='sent_date2_', coordinate=polygon,
